...
from phenopacket_mapper.data_standards import CodeSystem, Cardinality, data_node_classes
...
class DataSection:
    ...
    name: str = field()
    id: str = field(default=None)
    fields: Tuple[data_node_classes, ...] = field(default_factory=tuple)
    required: bool = field(default=False)
    cardinality: Cardinality = field(default_factory=Cardinality)
...
class DataModel:
    ...
    fields: Tuple[data_node_classes, ...] = field()
